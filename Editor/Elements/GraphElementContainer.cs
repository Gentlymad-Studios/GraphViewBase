...
namespace GraphViewBase {
    ...
    public class GraphElementContainer : VisualElement, ISelector, IPositionable, IDropPayload {
        ...
        public void ClearSelection(bool notify=false) {
            ...
            if (notify) {
                m_GraphView.OnActionExecuted(Actions.SelectionCleared);
            }
        }
        ...
        private void HandleDragBegin(DragBeginEvent e, BaseEdge draggedEdge) {
            ...
            bool draggedInput;
            if (draggedEdge.Input == null) { draggedInput = true; } else if (draggedEdge.Output == null) { draggedInput = false; } else {
        ...
        private void HandleDrag(DragEvent e, BaseEdge draggedEdge) {
            ...
            for (int i = 0; i < m_Selection.Count; i++) {
                ...
                if (edge.IsInputPositionOverriden()) { edge.SetInputPositionOverride(newPosition); } else { edge.SetOutputPositionOverride(newPosition); }
            }
        }
